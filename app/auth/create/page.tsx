...
export default function CreateAccountPage() {
  ...
  const brownLine: React.CSSProperties = {
    height: 4,
  ...
  const controlBase: React.CSSProperties = {
    ...
    transition:
      'box-shadow 140ms ease, border-color 120ms ease, transform 60ms ease',
  };
...
/* =================== Customer Form =================== */
function CustomerForm({ fieldRow, inputBase, sectionTitle, groupTitle }: any) {
  return (
    <form>
      ...
      <div style={fieldRow}>
        <input style={inputBase} placeholder='* Full Name' />
      </div>
      <div style={fieldRow}>
        <input style={inputBase} placeholder='Phone Number' />
      </div>
      <div style={fieldRow}>
        <input style={inputBase} placeholder='SJSU ID' />
      </div>
